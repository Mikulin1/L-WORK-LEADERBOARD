        ...
        <header className={styles.container}>
            ...
            <div className={styles.infoContainer}>
                <div className={styles.iconContainer}>
                    <a href="https://discord.gg/Ej84a6g3gP" target="_blank" rel={"noreferrer"}>
                    ...
                    <a href="https://t.me/justlwork" target="_blank"  rel={"noreferrer"}>
                ...
                <div className={styles.linkContainer}>
                    <a   href="https://forms.gle/aDv9GaSUxEoLsbcU7" target="_blank" className={styles.link}  rel={"noreferrer"}>ПОДАТЬ ЗАЯВКУ</a>
                    <a   href="https://lwork.gitbook.io/new-world/" target="_blank" className={styles.link}  rel={"noreferrer"}>КАК НАЧАТЬ</a>
                </div>
            </div>
